...
import { Lightbulb, BookOpen, Sparkles, Coins } from 'lucide-react';
  ...
  return (
    ...
    <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden'>
      ...
      <div className='p-6 space-y-6'>
        {/* Generate Summary */}
        <div className='group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border hover:border-slate-300/60 hover:shadow-md transition-all duration-200'>
          <div className='flex items-start justify-between gap-4'>
            <div className='flex-1'>
              <div className='flex items-center gap-2 mb-2'>
                ...
                <h4 className='font font-semibold text-slate-900'>
                  Generate Summary
                </h4>
              </div>
            ...
            <div className='flex items-center gap-3'>
              <input
                ...
                <button
                  ...
                  className='shrink-0 h-11 px-5 bg-linear-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95'
                  >
