...
const QuizCard = ({quiz, onDelete}) => {
  return (
   <div className='group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl p-4 hover:border-emerald-300 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-200 flex flex-col justify-between '>
    <button
      onClick={(e) => {
        e.stopPropagation();
        onDelete(quiz);
