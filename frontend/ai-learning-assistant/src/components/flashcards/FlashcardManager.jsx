          ...
          <div className='flex flex-col items-center space-y-8'>
            ...
            <div className='flex items-center gap-6'>
              <button
                ...
                className='group flex items-center h-11 px-5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium rounded-xl transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100'
                >
                  <ChevronLeft
                ...
                <button
                 ...
                 disabled={selectedSet.cards.length <= 1}
                 className='group flex items-center gap-2 h-11 px-5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium rounded-xl transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100'
                 >
                  Next
                    <ChevronRight
                      className='w-4 h-4 group-hover:-translate-x-0.5 transition-transform duration-200'
  ...
  const renderSetList = () => {
    ...
    return (
      <div className='flex flex-col items-center justify-center py-16 px-6'>
        <div className='inline-flex w-16 h-16 rounded-2xl bg-linear-to-br from-emerald-100 to-teal-100 items-center justify-center mb-6'>
        ...
        <button
          ...
          disabled={generating}
          className='group inline-flex items-center gap-2 px-6 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100'
         >
          {generating ? (
            <>
           ...
           >
            ...
            <button
              ...
              <div className='space-y-4'>
                <div className='inline-flex w-12 h-12 rounded-xl bg-linear-to-br from-emerald-100 to-teal-100 items-center justify-center'>
