...
const DocumentCard = ({ document, onDelete }) => {
  ...
  return <div 
       ...
       {/* Hover Indicator */}
       <div className='absolute inset-0 rounded-2xl bg-linear-to-br from-emerald-500/0 to-teal-500/0 group-hover:from-emerald-500/5 group-hover:t0-teal-500/5 transition-all duration-300 pointer-events-none' >
       </div>
