              ...
              {[
                ...
                .map((activity, index) => (
                  <div 
                    ...
                    className="group flex items-center justify-between p-4 bg-slate-50/50 border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200 "
                    >
