...
const QuizResultPage = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto'>
      ...
      <div className='mb-6'>
        <Link
         to={quiz.document ? `/documents/${quiz.document._id}` : '/documents'}
         ...
         >
          ...
          Back to {quiz.document ? 'Document' : 'Documents'}
         </Link>
      </div>
    ...
    <div className='space-y-6'>
          ...
          >
            <div className='flex items-start justify-between gap-4 mb-3'>
              <div className='flex-1'>
                <div className='inline-flex text-center gap-2 px-3 py-1 bg-slate-200 border border-slate-200 rounded-lg mb-3'>
             ...
             {/* Explanation */}
             {result.explanation && (
              <div className='b-4 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl'>
     ...
     <div className='mt-8 flex justify-center'>
      <Link to={quiz.document ? `/documents/${quiz.document._id}` : '/documents'}>
       <button className='group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden'>
        <span className='relative z-10 flex items-center gap-2'>
          <ArrowLeft className='w-4 h-4 group-hover:-translate-x-1 transition-transform duration-200' strokeWidth={2.5} />
           Return to {quiz.document ? 'Document' : 'Documents'}
        </span>
